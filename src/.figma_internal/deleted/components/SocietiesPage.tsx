...
import { Search, Users, ExternalLink, Calendar, MapPin, Linkedin, Instagram } from 'lucide-react';
              ...
              <div>
                ...
                <div className="flex items-center gap-4 mb-4 text-sm">
                  <div className="flex items-center gap-1" style={{ color: '#A0AEC0' }}>
                    ...
                    <span className="text-[#0077B5]">@{society.name.toLowerCase().replace(/\s+/g, '')}</span>
                  </div>
                  <div className="flex items-center gap-1" style={{ color: '#A0AEC0' }}>
                    <Instagram size={14} style={{ color: '#E4405F' }} />
                    <span className="text-[#E4405F]">{society.instagram}</span>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="space-y-1">
                    {society.achievements.map((event, index) => (
